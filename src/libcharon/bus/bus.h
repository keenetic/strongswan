...
enum alert_t {
	...
	/* IKEv1 notifies */
	ALERT_PROPOSAL_MISMATCH_IKEV1_IKE,
	ALERT_PROPOSAL_MISMATCH_IKEV1_IPSEC,
	ALERT_CHILDSA_ESTABLISHED,
	ALERT_WRONG_REMOTE_ID_IKEV1,
	ALERT_REMOTE_NOTIFY_AUTH_FAILED,
	ALERT_NO_ROUTE,
	ALERT_XAUTH_CLIENT_FAILED,
	ALERT_XAUTH_SERVER_FAILED,
	ALERT_INVALID_KEY,
	ALERT_INVALID_TRAFFIC_SELECTORS_IKEV1,

	/* IKEv2 notifies */
	ALERT_PROPOSAL_MISMATCH_IKEV2_IKE,
	ALERT_PROPOSAL_MISMATCH_IKEV2_IPSEC,
	ALERT_INVALID_TRAFFIC_SELECTORS_IKEV2,
	ALERT_INVALID_DH_GROUP_IKEV2_IPSEC,
	ALERT_CHILD_SA_FAILURE,
