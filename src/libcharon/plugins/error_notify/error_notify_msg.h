...
enum {
	...
	ERROR_NOTIFY_RETRANSMIT_SEND = 2000,

	ERROR_NOTIFY_CHILDSA_ESTABLISHED = 221,
	ERROR_NOTIFY_WRONG_REMOTE_ID_IKEV1 = 222,
	ERROR_NOTIFY_REMOTE_NOTIFY_AUTH_FAILED = 223,

	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IKE = 224,
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IPSEC = 225,

	ERROR_NOTIFY_NO_ROUTE = 226,

	ERROR_NOTIFY_XAUTH_CLIENT_FAILED = 227,
	ERROR_NOTIFY_XAUTH_SERVER_FAILED = 228,

	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV2_IKE = 229,
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV2_IPSEC = 230,
	ERROR_NOTIFY_INVALID_TRAFFIC_SELECTORS_IKEV2 = 231,
	ERROR_NOTIFY_INVALID_DH_GROUP_IKEV2_IPSEC = 232,

	ERROR_NOTIFY_INVALID_KEY = 233,

	ERROR_NOTIFY_PEER_ADDRESS_FAILED = 234,

	ERROR_NOTIFY_CHILD_SA_FAILURE = 235,

	ERROR_NOTIFY_INVALID_TRAFFIC_SELECTORS_IKEV1 = 236,

	ERROR_NOTIFY_GENERAL_ERROR = 300
