...
enum {
	...
	ERROR_NOTIFY_CHILDSA_ESTABLISHED = 21,
	ERROR_NOTIFY_WRONG_REMOTE_ID_IKEV1 = 22,
	ERROR_NOTIFY_REMOTE_NOTIFY_AUTH_FAILED = 23,

	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IKE = 24,
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IPSEC = 25
};
