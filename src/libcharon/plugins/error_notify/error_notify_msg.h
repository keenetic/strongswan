...
enum {
	...
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1 = 2100,
	ERROR_NOTIFY_CHILDSA_ESTABLISHED = 2101,
	ERROR_NOTIFY_WRONG_REMOTE_ID_IKEV1 = 2102,
	ERROR_NOTIFY_REMOTE_NOTIFY_AUTH_FAILED = 2103,

	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IKE = 2104,
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV1_IPSEC = 2105
	ERROR_NOTIFY_NO_ROUTE = 2106,

	ERROR_NOTIFY_XAUTH_CLIENT_FAILED = 2107,
	ERROR_NOTIFY_XAUTH_SERVER_FAILED = 2108,

	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV2_IKE = 2109,
	ERROR_NOTIFY_PROPOSAL_MISMATCH_IKEV2_IPSEC = 2110,
	ERROR_NOTIFY_INVALID_TRAFFIC_SELECTORS_IKEV2 = 2111,
	ERROR_NOTIFY_INVALID_DH_GROUP_IKEV2_IPSEC = 2112,
	ERROR_NOTIFY_INVALID_KEY = 2113,

	ERROR_NOTIFY_PEER_ADDRESS_FAILED = 2114,

	ERROR_NOTIFY_GENERAL_ERROR = 2190
};
